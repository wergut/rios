...
var swiper1 = new Swiper(".swiper-reviews-slider", {
    navigation: {
...
let elements1 = document.querySelectorAll('#stats');
...
function outNum(num, elem) {
    ...
    var n2 = 0;
    var n3 = 0;
    var t = Math.round(time / (90 / step));
    var t1 = Math.round(time / (3 / step));
    var t2 = Math.round(time / (70 / step));
    var t3 = Math.round(time / (35 / step));
    ...
    var e1 = document.getElementById('number1');
    ...
    var e2 = document.getElementById('number2');
    ...
    var e3 = document.getElementById('number3');
